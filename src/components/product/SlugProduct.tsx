...
const SingleProduct = ({ productData }: Props) => {
  ...
  return (
    <div className=" mt-20">
      <button
        onClick={() => router.back()}
        className=" container font-medium hover:text-red-600 animation mx-auto mb-3 cursor-pointer flex items-center"
      >
        ...
        <div className=" flex flex-col gap-6">
          ...
          <div className=" flex gap-3 flex-wrap">
            {productData?.data?.images?.map((image, index) => (
              <div
                className={`w-28 h-28 animation cursor-pointer rounded-md overflow-hidden ${
